...
- [Samples/regression.md](Samples/regression.md)：涵盖所有渲染特性的主要测试文档（代码高亮、数学公式、Callouts、脚注、安全拦截等）。
...
- [Samples/regression.md](Samples/regression.md): Primary test document covering all rendering features — syntax highlighting, math blocks, callouts, footnotes, and security blocking.
