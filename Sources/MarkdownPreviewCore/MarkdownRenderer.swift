...
private class SwiftMarkdownHTMLRenderer: MarkupVisitor {
    ...
    private func renderImage(_ image: Image) -> (html: String, kind: String, caption: String?) {
        ...
        case .missing(let path):
            ...
            let html = #"<span class="image-placeholder image-missing"><svg class="placeholder-icon" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg><span class="placeholder-text">Missing image: \#(HTMLEscaping.text(path))</span></span>"#
            return (html, "image-missing", nil)
        case .blockedRemote(let path):
            addWarning(.blockedRemoteResource(path))
            let html = #"<span class="image-placeholder image-blocked"><svg class="placeholder-icon" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="9" x2="15" y2="15"></line><line x1="15" y1="9" x2="9" y2="15"></line></svg><span class="placeholder-text">Remote image blocked</span></span>"#
            return (html, "image-blocked", nil)
        }
    }
